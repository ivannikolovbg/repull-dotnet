...
namespace Repull.SDK.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        public BookingAvailabilityUpdate_dateRange()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Repull.SDK.Models.BookingAvailabilityUpdate_dateRange"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Repull.SDK.Models.BookingAvailabilityUpdate_dateRange CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Repull.SDK.Models.BookingAvailabilityUpdate_dateRange();
        }
        /// <summary>
