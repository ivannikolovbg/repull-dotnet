...
namespace Repull.SDK.V1.Usage.Tier
{
    ...
    public partial class TierGetResponse_limits : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Repull.SDK.V1.Usage.Tier.TierGetResponse_limits"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Repull.SDK.V1.Usage.Tier.TierGetResponse_limits CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Repull.SDK.V1.Usage.Tier.TierGetResponse_limits();
        }
        /// <summary>
