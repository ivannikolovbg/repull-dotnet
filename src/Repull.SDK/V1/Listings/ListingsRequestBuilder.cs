...
using Repull.SDK.V1.Listings.Status;
...
namespace Repull.SDK.V1.Listings
{
    ...
    public partial class ListingsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Repull.SDK.V1.Listings.Status.StatusRequestBuilder Status
        {
            get => new global::Repull.SDK.V1.Listings.Status.StatusRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable restore
            ...
            public string Cursor { get; set; }
#endif
            /// <summary>Comma-separated optional expansions. Currently supported: `content`, `details`, `thumbnail`. `thumbnail` guarantees `thumbnailUrl` on every row and is the only expansion that applies to inactive listings. Unknown values return 422 with a `valid_values` envelope. (Note: `amenities` is not yet supported on the list endpoint — use the detail endpoint to fetch amenity rows for a single listing.)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
