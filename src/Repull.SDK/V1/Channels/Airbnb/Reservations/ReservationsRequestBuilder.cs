...
namespace Repull.SDK.V1.Channels.Airbnb.Reservations
{
    ...
    public partial class ReservationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ReservationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/channels/airbnb/reservations{?account_id*,cursor*,end_date*,include_total*,limit*,listing_id*,offset*,start_date*,status*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Repull.SDK.V1.Channels.Airbnb.Reservations.ReservationsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReservationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/channels/airbnb/reservations{?account_id*,cursor*,end_date*,include_total*,limit*,listing_id*,offset*,start_date*,status*}", rawUrl)
        {
        }
        /// <summary>
