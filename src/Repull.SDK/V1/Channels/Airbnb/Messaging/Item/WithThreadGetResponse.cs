...
namespace Repull.SDK.V1.Channels.Airbnb.Messaging.Item
{
    ...
    public partial class WithThreadGetResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>An Airbnb message thread.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Repull.SDK.Models.AirbnbThread? Data { get; set; }
#nullable restore
#else
        public global::Repull.SDK.Models.AirbnbThread Data { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Repull.SDK.V1.Channels.Airbnb.Messaging.Item.WithThreadGetResponse"/> and sets the default values.
        /// </summary>
        public WithThreadGetResponse()
        {
        ...
        public static global::Repull.SDK.V1.Channels.Airbnb.Messaging.Item.WithThreadGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Repull.SDK.V1.Channels.Airbnb.Messaging.Item.WithThreadGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "data", n => { Data = n.GetObjectValue<global::Repull.SDK.Models.AirbnbThread>(global::Repull.SDK.Models.AirbnbThread.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Repull.SDK.Models.AirbnbThread>("data", Data);
