...
namespace Repull.SDK.V1.Channels.Airbnb.Listings.Item.Quality
{
    ...
    public partial class QualityGetResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Shape depends on `type`: an object `{ standards, issues }` for `all`/`standards`, or an array for `issues`/`stats`.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Quality.QualityGetResponse"/> and sets the default values.
        /// </summary>
        public QualityGetResponse()
        {
        ...
        public static global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Quality.QualityGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Quality.QualityGetResponse();
        }
        /// <summary>
