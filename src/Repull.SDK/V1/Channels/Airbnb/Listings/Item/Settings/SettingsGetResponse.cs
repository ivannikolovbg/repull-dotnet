...
namespace Repull.SDK.V1.Channels.Airbnb.Listings.Item.Settings
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Shape depends on `type`: `{ hosts, locales }` for `all`, or an array for `hosts`/`permits`/`locales`.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Settings.SettingsGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Settings.SettingsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Settings.SettingsGetResponse();
        }
        /// <summary>
