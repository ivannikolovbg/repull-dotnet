...
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\channels\airbnb\listings\{id}\photos\order
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class OrderRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OrderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/channels/airbnb/listings/{id}/photos/order", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OrderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/channels/airbnb/listings/{id}/photos/order", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutResponse"/></returns>
...
#nullable enable
        public async Task<global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutResponse?> PutAsOrderPutResponseAsync(global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutResponse> PutAsOrderPutResponseAsync(global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutResponse>(requestInfo, global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Set the order of a listing&apos;s photo tour in one call. **Write-side** — calls Airbnb upstream.Send the photo ids in the order you want them shown, first photo first. Ids you leave out keep their current relative order behind the ones you list, so moving one photo to the front is `{&quot;photo_ids&quot;: [&quot;&lt;id&gt;&quot;]}`. Positions are then written as a dense run starting at 1.Airbnb has no bulk photo endpoint — order is one `sort_order` per photo — so this saves a loop of up to 200 requests against your rate limit and makes the partial-failure case reportable. How much is atomic:- Everything is validated before anything is written. A duplicate id, an id that is not on this listing, an inactive listing or a missing connection all fail with **zero** upstream writes.- Only photos whose position actually changes are written; re-sending the order you already have writes nothing.- On the first upstream failure the run stops — nothing after it is attempted. The error carries `applied`, `failed_photo_id` and `not_attempted`, uses Airbnb&apos;s own status (`422` rejected / `403` reauth / `429` / `502`), and the operation is idempotent: re-send the identical body to finish the run.- Our stored copy records what actually landed, never the intent.Validation is against our cached copy of the tour, so a listing whose photos have never synced returns `404` — use `PATCH /photos` (which needs no cache) until the first sync lands.Returns `403 listing_inactive` when the listing is inactive. An inactive listing keeps syncing, but cannot be read or changed through the API until it is activated.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderResponse?> PutAsync(global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderResponse> PutAsync(global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderResponse>(requestInfo, global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Set the order of a listing&apos;s photo tour in one call. **Write-side** — calls Airbnb upstream.Send the photo ids in the order you want them shown, first photo first. Ids you leave out keep their current relative order behind the ones you list, so moving one photo to the front is `{&quot;photo_ids&quot;: [&quot;&lt;id&gt;&quot;]}`. Positions are then written as a dense run starting at 1.Airbnb has no bulk photo endpoint — order is one `sort_order` per photo — so this saves a loop of up to 200 requests against your rate limit and makes the partial-failure case reportable. How much is atomic:- Everything is validated before anything is written. A duplicate id, an id that is not on this listing, an inactive listing or a missing connection all fail with **zero** upstream writes.- Only photos whose position actually changes are written; re-sending the order you already have writes nothing.- On the first upstream failure the run stops — nothing after it is attempted. The error carries `applied`, `failed_photo_id` and `not_attempted`, uses Airbnb&apos;s own status (`422` rejected / `403` reauth / `429` / `502`), and the operation is idempotent: re-send the identical body to finish the run.- Our stored copy records what actually landed, never the intent.Validation is against our cached copy of the tour, so a listing whose photos have never synced returns `404` — use `PATCH /photos` (which needs no cache) until the first sync lands.Returns `403 listing_inactive` when the listing is inactive. An inactive listing keeps syncing, but cannot be read or changed through the API until it is activated.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Repull.SDK.V1.Channels.Airbnb.Listings.Item.Photos.Order.OrderRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
