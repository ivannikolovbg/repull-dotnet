...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Repull.SDK.V1.Webhooks.Test.TestPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Repull.SDK.V1.Webhooks.Test.TestPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Repull.SDK.V1.Webhooks.Test.TestPostRequestBody();
        }
        /// <summary>
